...
const DimensionPage = (prop) => {
  ...
  React.useEffect(() => {
    const storedPersonaLength= localStorage.getItem('selectedPersonaLength');
    const storedApproach = localStorage.getItem('selectedApproach');
  ...
  React.useEffect(() => {
      localStorage.setItem('selectedPersonaLength', JSON.stringify(selectedPersonaLength));
      localStorage.setItem('selectedApproach', JSON.stringify(selectedApproach));
      localStorage.setItem('selectedStructure', JSON.stringify(selectedStructure));
